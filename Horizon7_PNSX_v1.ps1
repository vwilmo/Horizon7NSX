#Script
    param (
        ...
        Get-NsxFirewallSection $SNHZN7InfraMgmtSectionName  | New-NsxFirewallRule -Name $RNHZN7Admin2Name -source $SGHZN7AdminConsole -destination $SGHZN7ConnServer -service $SVHZN7Admin2ConnServer,$SVHZN7Admin2vCenter,$SVHZN7Admin2APPVMGR,$SVHZN7Admin2VIDM -action allow -AppliedTo $SGHZN7AdminConsole,$SGHZN7ConnServer -Position Top
        Get-NsxFirewallSection $SNHZN7InfraMgmtSectionName  | New-NsxFirewallRule -Name $RNHZN7Admin2UAGName -source $SGHZN7AdminConsole -destination $SGHZN7V4H -service $SVHZN7Admin2V4H -action allow -AppliedTo $SGHZN7AdminConsole,$SGHZN7V4H -Position Top
        Get-NsxFirewallSection $SNHZN7InfraMgmtSectionName  | New-NsxFirewallRule -Name $RNHZN7Admin2VIDMName -source $SGHZN7AdminConsole -destination $SGHZN7UAG -service $SVHZN7Admin2UAG -action allow -AppliedTo $SGHZN7AdminConsole,$SGHZN7UAG -Position Top
