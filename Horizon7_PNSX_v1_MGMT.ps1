#Script
    param (
        ...
        $SGHZN7ConnServer = New-NsxSecurityGroup -name $SGHZN7ConnServerName -IncludeMember (Get-NsxSecurityTag -Name $STHZN7ConnServerName)
            Add-NsxSecurityGroupMember -SecurityGroup (Get-NsxSecurityGroup -name $SGHZN7ConnServerName) -Member (Get-NsxIpSet -name $IPHorizon7ConnServerVIPName)
        $SGHZN7vIDM = New-NsxSecurityGroup -name $SGHZN7vIDMName -IncludeMember (Get-NsxSecurityTag -Name $STHZN7vIDMName)
            Add-NsxSecurityGroupMember -SecurityGroup (Get-NsxSecurityGroup -name $SGHZN7vIDMName) -Member (Get-NsxIpSet -name $IPHorizon7vIDMVIPName)
        $SGHZN7UAG = New-NsxSecurityGroup -name $SGHZN7UAGName -IncludeMember (Get-NsxSecurityTag -Name $STHZN7UAGName)
            Add-NsxSecurityGroupMember -SecurityGroup (Get-NsxSecurityGroup -name $SGHZN7UAGName) -Member (Get-NsxIpSet -name $IPHorizon7UAGVIPName)
